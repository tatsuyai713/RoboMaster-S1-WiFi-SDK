...
class Action:
    """Small synchronous compatibility implementation of DJI's Action API."""

    def __init__(self, accepted: bool = True, **kw) -> None:  # noqa: ANN003
        self.accepted = bool(accepted)
        self._action_id = -1
        self._state = ACTION_SUCCEEDED if self.accepted else ACTION_REJECTED
        self._percent = 100 if self.accepted else 0
    ...
    def encode(self):
        raise NotImplementedError("Action encoding is handled by the Lab bridge")
...
class TextAction(Action):
    ...
    @text_proto.setter
    def text_proto(self, text_cmd) -> None:  # noqa: ANN001
...
class ActionDispatcher:
    ...
    def get_msg_by_action(self, action):  # noqa: ANN001
        raise NotImplementedError("Action messages are encoded by the Lab bridge")
